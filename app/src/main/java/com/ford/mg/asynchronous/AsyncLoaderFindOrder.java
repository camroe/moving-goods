...
public class AsyncLoaderFindOrder extends AsyncTask<Integer, Void, Order> {
    public static final String TAG = AsyncLoaderFindOrder.class.getCanonicalName();
    private OrderCombinationIF orderImpl;
    private Activity activity;


    public AsyncLoaderFindOrder(Activity callingActivity, OrderCombinationIF orderImpl) {
