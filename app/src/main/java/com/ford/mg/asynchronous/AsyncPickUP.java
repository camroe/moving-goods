...
public class AsyncPickUP extends AsyncTask<Integer,Void,Void> {
    public static final String TAG = AsyncPickUP.class.getCanonicalName();
    private OrderCombinationIF orderCombinationIF;

    public AsyncPickUP(OrderCombinationIF orderCombinationIF) {
    ...
    protected Void doInBackground(Integer... integers) {
        ...
        if (null == orderID)
            ...
            Log.i(methodTag, "Pickup for OrderID:" + orderID + " processing in background:");
        orderCombinationIF.orderPickedup(orderID);
        return null;
    }
}